...
const HonorPage = () => {
  ...
  return (
    <>
      ...
      <h3 className=" p-5 text-4xl lg:pl-36 lg:pr-96">
        Albison Sharaf Kodeksi
      </h3>
      <div className="p-5 mb-72 lg:pl-36 lg:pr-96">
        <p>
          ...
          <Link
            className="text-blue"
            onClick={() => {
              second.current.classList.remove("show-text");
              scrollTo(0, second.current.offsetTop - 200);
              console.log(second.current.classList.add("show-text"));
              setTimeout(() => {
                second.current.classList.remove("show-text");
              }, 1200);
            }}
        ...
        <ol className="list-decimal">
          <li>
            ...
            beparvolik bilan qarab, Albison Akademyasi tomonidan taqdim
            etilayotgan grant kurslarini suiisteʼmol qilishi ya'ni dasturlash
            kurslarini tugatmasdan kursni tashlab ketish, ustozlarga nisbatan
            hurmatsizlik qilish va berilgan vazifalarga jiddiy yondashmaslik
            kuzatilishi mumkin. Bu kabi holatlarda Albison Akademyasi
            tinglovchini kursdan chetlatish sababi bilan tanishtirgan holda
            kursdan chetlatadi.
          </li>
          <br />
          <li ref={second}>
          ...
          <br />
          <li>
            <strong>Halollik va rostgo'ylik: </strong>dasturlash kurslarini
            o'rganishni boshlagan har bir tinglovchi dars jarayonidan tashqari
            o'rganish jarayoni uchun javobgar. Albison Akademyasi dars berish
            tizimi ham ishonch asosida yaratilgan bo'lib, biz har bir tinglovchi
            dars jarayonida va darsdan tashqari beriladigan har bir topshiriqni
            o'zi bajarishiga ishonamiz. Uyga vazifa, oraliq va yakuniy
            imtihonlar har doim tinglovchi tomonidan bajarilishi va boshqa kurs
            tinglovchilardan ko'chirmasligi talab etiladi. Topshiriqlarni har
            qanday ko'rinishda qisman yoki to'liq ko'chirish holati aniqlanganda
            ko'chirgan va ko'chirtirgan tinglovchi kursdan chetlatiladi. Izoh:
            Hech qachon ta'lim olish jarayonida ustozlarga yolg'on gapirishga
            yoki firibgarlik qilishga urinmang. Biz o'zimiz bergan topshiriqdan
            yoki boshqa tinglovchidan ko'chirganingizni albatta aniqlaymiz.
          </li>
          <br />
          <li>
            <strong>Barqarorlik va tinimsiz mehnat: </strong>darslarga muntazam
            qatnashish va uyga berilgan topshiriqlarni to'liq bajarib borish bu
            dasturlashni mukammal o'rganishingiz garovi. Agar tinglovchi har xil
            fors-major jumladan betob bo'lib qolish, oilaviy sabablarga ko'ra
            kela olmasligi ma'lum bo'lsa Albison Akademyasi ma'muriyatini
            oldindan ogohlantirishi talab etiladi. Bunday holatda keyingi
            qatnashadigan darsida qolib ketgan uyga vazifani topshirishi va
            o'quv dasturidan qolib ketmaslik uchun videodarsliklardan
